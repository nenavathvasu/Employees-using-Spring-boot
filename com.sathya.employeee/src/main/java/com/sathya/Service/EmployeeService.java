...
public class EmployeeService {
 ...
 // Dept + Gender + Salary Between
    public List<Employee> getEmployees(
        ...
        return repository.findEmployeesByDeptGenderAndSalaryRange(
